namespace Muhasebev2
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            label3.Font = new Font("Caviar Dreams", 11.25F, FontStyle.Regular, GraphicsUnit.Point, 162);
            label3.Location = new Point(144, 152);
            label3.Name = "label3";
            ...
            Controls.Add(label2);
            Controls.Add(label1);
            Font = new Font("Caviar Dreams", 9F, FontStyle.Bold, GraphicsUnit.Point, 162);
            Name = "Form1";
            Text = "Hesap Oluştur";
            ResumeLayout(false);
            PerformLayout();
